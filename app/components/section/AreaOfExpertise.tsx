...
const features: Feature[] = [
  { icon: <MentoringIcon />, title: "Web Apps", description: "Get connected with a mentor that will help you pave your career path." },
  { icon: <OpportunitiesIcon />, title: "Mobile Apps", description: "Get Internships and Job opportunities and gain experience while you learn." },
  { icon: <ResourcesIcon />, title: "UI/UX", description: "Get Free resources related to Designing and Development from the community." },
  { icon: <HelpIcon />, title: "API", description: "Get your portfolio and projects reviewed by industry experts and mentors." },
];
