...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  useEffect(() => {
    ...
    // Assign the NodeList to the mutable ref object
    (cornersRef as React.MutableRefObject<NodeListOf<HTMLDivElement> | null>).current = cursor.querySelectorAll<HTMLDivElement>(
